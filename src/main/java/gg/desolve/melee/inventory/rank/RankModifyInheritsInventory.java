...
public class RankModifyInheritsInventory implements InventoryProvider {

    private final Profile profile;
    private final Rank rank;

    public RankModifyInheritsInventory(Profile profile, Rank rank) {
    ...
    public static SmartInventory getInventory(Profile profile, Rank rank) {
        return SmartInventory.builder()
                ...
                .provider(new RankModifyInheritsInventory(profile, rank))
                .size(3, 9)
